...
export class PageSearchbar {
  ...
  toggleAttr() {
    let dynamicAttr = document.getElementById('dynamicAttr');
  ...
  toggleProp() {
    let dynamicProp: any = document.getElementById('dynamicProp');
    ...
    return (
      <div class="ion-page">
        ...
        <ion-content id="content">
          ...
          <p padding>
            <ion-button expand="block" onClick={() => true}>
              Change Value
            </ion-button>
          </p>

          <div padding-horizontal>
            <ion-button expand="block" onClick={() => this.toggleProp()}>
              Toggle Property
            </ion-button>
          </div>
          <div padding>
            <ion-button expand="block" color="secondary" onClick={() => this.toggleAttr()}>
              Toggle Attribute
            </ion-button>
          </div>
        </ion-content>
