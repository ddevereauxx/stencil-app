...
export class PageItemSliding {
  ...
  dynamicShowOptions: any = document.getElementsByClassName('show-options');
  dynamicText: any = true;
  moreTextSpans: any = document.getElementsByClassName('more-text');
  archiveTextSpans: any = document.getElementsByClassName('archive-text');
  ...
  changeDynamicText() {
    ...
    for (var i = 0; i < this.moreTextSpans.length; i++) {
      var moreText = this.dynamicText ? 'Changed More' : 'Dynamic More';
      this.moreTextSpans[i].innerHTML = moreText;
    }

    for (var i = 0; i < this.archiveTextSpans.length; i++) {
      var archiveText = this.dynamicText ? 'Changed Archive' : 'Dynamic Archive';
    ...
    return (
      <div class="ion-page">
        ...
        <ion-content>
          ...
          <div padding>
            <ion-button expand="block" onClick={() => this.toggleSliding()}>Toggle sliding</ion-button>
            <ion-button expand="block" onClick={() => this.toggleDynamicOptions()}>Toggle Dynamic Options</ion-button>
            <ion-button expand="block" onClick={() => this.closeOpened()}>Close Opened Items</ion-button>
          </div>
          ...
          <ion-list id="list">
            <div class="nested-div">
              ...
              <ion-item-sliding id="item100">
                ...
                <ion-item-options side="start">
                  <ion-item-option onClick={() => this.noclose('item100')}>
                    No close
                  </ion-item-option>
                </ion-item-options>
              ...
              <ion-item-sliding id="item0">
                ...
                <ion-item-options class="sliding-enabled">
                  <ion-item-option color="primary" onClick={() => this.archive('item0')}>Archive</ion-item-option>
                  <ion-item-option color="danger" onClick={() => this.del('item0')}>Delete</ion-item-option>
                </ion-item-options>
              </ion-item-sliding>
              ...
              <ion-item-sliding id="item1">
                ...
                <ion-item-options side="start" class="sliding-enabled">
                  <ion-item-option color="primary" onClick={() => this.archive('item1')}>Archive</ion-item-option>
                  <ion-item-option color="danger" onClick={() => this.del('item1')}>Delete</ion-item-option>
                </ion-item-options>
              </ion-item-sliding>
