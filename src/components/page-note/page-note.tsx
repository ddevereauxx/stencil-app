        ...
        <ion-content>
          <ion-list>
            ...
            <ion-item onClick={() => this.toggleColor()}>
              <ion-note id="toggleColor" slot="end" color="primary">
                primary
              </ion-note>
          ...
          <ion-list>
            ...
            <ion-item>
              <ion-label>Secondary Note</ion-label>
              <ion-note slot="start" color="secondary">
                99
              </ion-note>
            </ion-item>
            ...
            <ion-item>
              <ion-label>Tertiary Note</ion-label>
              <ion-note slot="start" color="tertiary">
                99
              </ion-note>
            </ion-item>
            ...
            <ion-item>
              <ion-label>Success Note</ion-label>
              <ion-note slot="start" color="success">
                99
              </ion-note>
            </ion-item>
            ...
            <ion-item>
              <ion-label>Danger Note</ion-label>
              <ion-note slot="start" color="danger">
                99
              </ion-note>
            </ion-item>
            ...
            <ion-item>
              <ion-label>Light Note</ion-label>
              <ion-note slot="start" color="light">
                99
              </ion-note>
            </ion-item>
