      ...
      <div class="ion-page">
        ...
        <div style={{ display: 'flex', flex: '1' }}>
          <ion-content padding style={{ 'text-align': 'center', flex: '2' }} id="content">
            ...
            <p>
              <ion-button onClick={() => this.toggleDisplay('header')} color="secondary">
                Toggle header
              </ion-button>
              <ion-button onClick={() => this.toggleDisplay('footer')} color="secondary">
                Toggle footer
              </ion-button>
              <ion-button onClick={() => this.toggleDisplay('toolbar2')} color="secondary">
                Toggle 2nd toolbar
              </ion-button>
            </p>
            <p>
              <ion-button onClick={() => this.toggleDisplay('content2')} color="danger">
                Toggle bottom content
              </ion-button>
              <ion-button onClick={() => this.toggleDisplay('content3')} color="danger">
                Toggle right content
              </ion-button>
            </p>
            <p>
              <ion-button onClick={() => this.myanimation()} color="dark">
                Animate
              </ion-button>
            </p>
            <f />
