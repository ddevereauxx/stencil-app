...
export class PageActionSheet {
  componentDidLoad() {
    window.addEventListener('ionActionSheetDidDismiss', e => {
    ...
    return (
      <div class="ion-page" main>
        ...
        <ion-content padding>
          ...
          <ion-button expand="block" id="basic" onClick={() => this.presentBasic()}>
            Basic
          </ion-button>
          <ion-button expand="block" id="noBackdropDismiss" onClick={() => this.presentNoBackdropDismiss()}>
            No Backdrop Dismiss
          </ion-button>
          <ion-button expand="block" id="alertFromActionSheet" onClick={() => this.presentAlert()}>
            Alert from Action Sheet
          </ion-button>
          <ion-button expand="block" id="scrollableOptions" onClick={() => this.presentScroll()}>
            Scrollable Options
          </ion-button>
          <ion-button expand="block" id="scrollWithoutCancel" onClick={() => this.presentScrollNoCancel()}>
            Scroll Without Cancel
          </ion-button>
          <ion-button expand="block" id="cancelOnly" onClick={() => this.presentCancelOnly()}>
            Cancel Only
          </ion-button>
          <ion-button expand="block" id="icons" onClick={() => this.presentIcons()}>
            Icons
          </ion-button>
          <ion-button expand="block" id="cssClass" onClick={() => this.presentWithCssClass()}>
            Custom CSS Class
          </ion-button>
        </ion-content>
      </div>
